...
git checkout -b branch-name xxxxxxxx
...
# and setup local branch to track remote branch from origin
git push -u origin branch-name
git push --set-upstream origin branch-name # same?

# delete a remote branch
git push origin --delete branch-name
```

(see [git branch](#git-checkout) for creating local branches)
...
* `soft` (default) preserves changes in undone revisions as unstaged changes
...
* a record of the original repo when a repo was cloned (e.g.as a copy on the website)  
* when you clone a repo, Git creates a remote called **origin** that points to the original repo
...
git branch -vv # 
git branch –remotes # see all your remote tracking branches
...
git pull origin master
git push --force
git push -u origin new-feature # push new-feature to the central repository (origin), and the -u flag adds it as a remote tracking branch
