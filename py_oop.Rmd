...
```{python}
# you can add new attributes like this, but I don't think it's recommended
class MyClass(object):
    pass
an_instance = MyClass()
an_instance.var = 20
...
* keywords start with `@`  
* e.g. 
  * `@classmethod` (see [class methods](#classmethods))  
  * `@staticmethod` (see [static methods](#staticmethods)) 
