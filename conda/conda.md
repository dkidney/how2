...
``` sh
conda --version
which conda # doesn't work anymore...
conda info
...
conda install keras matplotlib numpy pandas seaborn scikit-learn scipy statsmodels xgboost

# install a package or packages to a named environment
conda install --name py2 scipy numpy pandas scikit-learn matplotlib
